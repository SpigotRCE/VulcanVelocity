...
public final class Config {
    ...
    public static void initializeConfig() throws ObjectMappingException {
        ...
        try {
            YamlConfigurationLoader loader = ((YamlConfigurationLoader.Builder) ((Object) YAMLConfigurationLoader.builder().setPath(new File(VulcanVelocity.INSTANCE.getDataFolder(), "config.yml").toPath()))).build();
    ...
    static class Config$1
            extends TypeToken<String> {
    }
}
